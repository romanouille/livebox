...
function checkAddressWeb1(code) {
	
	var regexp = new RegExp("^[w]{3}.([a-zA-Z0-9\\-_]+\.){2,}[a-zA-Z]{2,4}$", "g");
...
function checkAddressWeb2(code) {
	
	var regexp = new RegExp("^^(http|https|ftp)://([a-zA-Z0-9-]+.)?([a-zA-Z0-9-]+.)?[a-zA-Z0-9-]+\.[a-zA-Z]{2,4}(:[0-9]+)?(/[a-zA-Z0-9-]*)?(.[a-zA-Z0-9]{1,4})?$", "g");
...
function checkAddressWeb3(code) {
	
	var regexp = new RegExp("([a-zA-Z0-9-]+\\.)?([a-zA-Z0-9-]+\\.)?[a-zA-Z0-9-]+\\.[a-zA-Z]{2,4}(:[0-9]+)?(/[a-zA-Z0-9-]*)?(.[a-zA-Z0-9]{1,4})?$", "g");
